...
**关键前提：透视图不能用来量尺寸。** AI 生成的"三视图"绝大多数是透视渲染贴了正交的标签，先做平行线测试判定。完整的审计流程、像素测量、剪影 IoU 闭环见 `references/reference-matching.md`。
...
| `references/reference-matching.md` | **有设计图/效果图要对齐时都读。** 图纸审计、像素测量、剪影 IoU 闭环 |
